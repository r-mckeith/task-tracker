...
type ReviewWeekScreenProps = StackScreenProps<DoStackParamList, 'ReviewWeek'>;

const ReviewWeekScreen: React.FC<ReviewWeekScreenProps> = ({ route, navigation }) => {
...
export default ReviewWeekScreen
